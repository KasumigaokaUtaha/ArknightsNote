...
struct RecruitmentStore {
    ...
    private let recruitmentCharacterNames: [String] = [
        ...
        "艾丝黛尔", "清流", "夜烟", "远山", "杰西卡", "流星", "白雪", "清道夫", "红豆", "杜宾", "缠丸", "霜叶", "慕斯", "砾", "暗索", "末药", "调香师", "角峰",
        "蛇屠箱", "古米", "地灵", "阿消", "猎蜂", "格雷伊", "苏苏洛", "桃金娘", "红云", "梅",
        "因陀罗", "火神", "白面鸮", "凛冬", "德克萨斯", "幽灵鲨", "蓝毒", "白金", "陨星", "梅尔", "赫默", "华法琳", "临光", "红", "雷蛇", "可颂", "普罗旺斯",
        "守林人", "崖心", "初雪", "真理", "狮蝎", "食铁兽", "夜魔", "诗怀娅", "格劳克斯", "星极", "送葬人", "槐琥",
        "能天使", "推进之王", "伊芙利特", "闪灵", "夜莺", "星熊", "塞雷娅", "银灰", "斯卡蒂", "陈", "黑", "赫拉格", "麦哲伦", "莫斯提马"
    ]

    func allTags() -> [String] {
        Category.allCases.flatMap { category in
            tagsOfCategory(category)
        }
    }
    ...
    func tagOfCategory(_ category: Category, value: Any) -> String? {
        ...
        if let tag = categoryValueToTag[valueString] {
            ...
            logger.debug(
                "Warning cannot find tag with category: \(category) and value: \(valueString)",
                metadata: nil,
                source: "RecruitmentStore"
            )
            return nil
        }
    }
