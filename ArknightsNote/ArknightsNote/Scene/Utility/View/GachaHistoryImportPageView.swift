...
class GachaHistoryImportPageView: UIView {
    ...
    private(set) var tokenTextField: UITextField!
    ...
    private func setup() {
        ...
        nextStepButton.titleLabel?.font = UIFont.systemFont(ofSize: 20)
        ...
        case .paste:
            ...
            tokenTextField.placeholder = "Paste your token here"
            tokenTextField.font = UIFont.systemFont(ofSize: 16, weight: .regular)
            tokenTextField.contentVerticalAlignment = UIControl.ContentVerticalAlignment.top
            tokenTextField.backgroundColor = .secondarySystemBackground
        ...
        case .paste:
            NSLayoutConstraint.activate([
                tokenTextField.topAnchor.constraint(equalTo: titleLabel.bottomAnchor, constant: 10),
                tokenTextField.heightAnchor.constraint(equalTo: safeAreaLayoutGuide.heightAnchor, multiplier: 0.4),
                tokenTextField.widthAnchor.constraint(equalTo: safeAreaLayoutGuide.widthAnchor, multiplier: 0.8),
                tokenTextField.centerXAnchor.constraint(equalTo: centerXAnchor),
