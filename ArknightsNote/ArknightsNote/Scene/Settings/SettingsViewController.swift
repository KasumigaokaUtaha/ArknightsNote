...
class SettingsViewController: UIViewController {
    ...
    let removeMessagesAlert: UIAlertController = {
        let alertMessage = NSLocalizedString(
            ...
            comment: "Alert message in settings screen"
        )
...
extension SettingsViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case 0:
            let cellText = NSLocalizedString(
                "Remove Messages",
                comment: "Text of remove messages option in settings screen"
            )
...
extension SettingsViewController: UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.section == 0, indexPath.row == 0 {
            ...
            present(removeMessagesAlert, animated: true, completion: nil)
        }
    }
}
